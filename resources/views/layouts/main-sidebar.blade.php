			...
			<div class="main-sidemenu">
				...
				<ul class="side-menu">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
						@can('قائمة الفواتير')
							<li><a class="slide-item" href="{{url('/' . $page='invoices') }}">قائمة الفواتير</a></li>@endcan
						@can('الفواتير المدفوعة')
							<li><a class="slide-item" href="{{ url('/' . $page='Invoice_Paid') }}">الفواتير المدفوعة</a></li>@endcan
						@can('الفواتير الغير مدفوعة')
							<li><a class="slide-item" href="{{ url('/' . $page='Invoice_UnPaid') }}">الفواتير الغير مدفوعة</a></li>@endcan
						@can('الفواتير المدفوعة جزئيا')
							<li><a class="slide-item" href="{{ url('/' . $page='Invoice_Partial') }}">الفواتير المدفوعة جزئيا</a></li>@endcan
							@can('أرشيف الفواتير')
							<li><a class="slide-item" href="{{ url('/' . $page='view_trash_invoce') }}">الفواتير  المتأرشفة</a></li>
					...
					@can('التقارير')
					<li class="side-item side-item-category">التقارير</li>@endcan
					<li class="slide">
						...
						<ul class="slide-menu">
						@can('تقرير الفواتير')
							<li><a class="slide-item" href="{{ url('/' . $page='cards') }}">تقارير الفواتير</a></li>@endcan
							@can('تقرير العملاء')
				...
				@can('المستخدمين')
					...
					<li class="slide">
						...
						@can('قائمة المستخدمين')
							...
							<li><a class="slide-item" href="{{ url('/' . $page='roles') }}">صلاحيات المستخدمين</a></li>@endcan
				...
				@can('الاعدادات')
					<li class="side-item side-item-category">الاعدادادت</li>@endcan
					<li class="slide">
						...
						<ul class="slide-menu">
						@can('الأقسام')
							<li><a class="slide-item" href="{{ url('/' . $page='sections') }}">الأقسام</a></li>@endcan
							@can('المنتجات')
							<li><a class="slide-item" href="{{ url('/' . $page='products') }}"> المنتجات</a></li>@endcan
							<li><a class="slide-item" href="{{ url('/' . $page='categories') }}"> الأصناف</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='suppliers') }}"> الموردين</a></li>
						</ul>
					</li>
